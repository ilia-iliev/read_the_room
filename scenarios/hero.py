...
dangerous when made to feel mocked or afraid of looking weak before your men. You hate being told what to do""",
    disposition={
        ...
        "Vesh": "your sharp little knife of a man, usually right, but a nag",
...
VESH = Character(
    name="Vesh",
    persona="""You are VESH, the advisor: a thin, sharp-eyed man, and you trust NOTHING. You have
...
makes you feel stupid with his sly words, and you respect raw nerve in anyone.""",
    disposition={
...
SCENARIO = Scenario(
    ...
    intro=(
        ...
        "Vesh, the thin, sharp-eyed man at his right hand, already whispering in Korg's ear, probably for your throat. "
